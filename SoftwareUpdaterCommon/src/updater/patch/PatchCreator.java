...
public class PatchCreator {
    ...
    /**
     * Sort the {@code list} in ascending order by the <b>new file</b> path in {@link OperationRecord}.
    ...
    /**
     * Sort the {@code list} in descending order by the <b>old file</b> path in {@link OperationRecord}.
     * @param list the list to sort
     */
