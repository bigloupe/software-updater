...
public class PatchTest {
  ...
  /**
   * @todo need to do test on doOperation and revert
   */
  @Test
  public void test() throws Exception {
    ...
    File oldFolder = new File(packagePath + "test1/PatchTest_old");
    File newFolder = new File(packagePath + "test1/PatchTest_new");
    File newOverOldFolder = new File(packagePath + "test1/PatchTest_new_over_old"); // this is the folder that contains all files after applying full patch of 'new' on 'old'
